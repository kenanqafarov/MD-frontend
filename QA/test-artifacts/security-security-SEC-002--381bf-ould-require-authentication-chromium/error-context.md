...
- Name: security/security.spec.ts >> SEC-002: No Token - Cannot Access Reservation Data >> reservation endpoints should require authentication
- Location: tests/security/security.spec.ts:34:3
