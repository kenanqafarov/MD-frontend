...
- Name: security/security.spec.ts >> SEC-001: No Token - Cannot Access Patient Data >> patient endpoints should require authentication
- Location: tests/security/security.spec.ts:8:3
