...
- Name: security/security.spec.ts >> SEC-003: No Token - Cannot Access Permission Data >> permission endpoints should require authentication
- Location: tests/security/security.spec.ts:42:3
