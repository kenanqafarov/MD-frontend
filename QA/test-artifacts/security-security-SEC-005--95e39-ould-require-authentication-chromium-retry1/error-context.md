...
- Name: security/security.spec.ts >> SEC-005: No Token - Cannot Access Warehouse Data >> warehouse endpoints should require authentication
- Location: tests/security/security.spec.ts:64:3
...
> 66  |     expect(status).toBe(401);
  ...
  158 | 
  159 | // ─────────────────────────────────────────────
  160 | // FRONTEND SECURITY CHECKS
  161 | // ─────────────────────────────────────────────
  162 | 
  163 | test.describe('SEC-UI-001: Direct Access to Protected Routes Without Auth', () => {
  164 |   test('should redirect to login when accessing protected route', async ({ browser }) => {
  165 |     // Fresh browser without auth
